    ...
    for article in squad_data['data']:
        for paragraph in article['paragraphs']:
            ...
            for qa in paragraph['qas']:
                ...
                simplified_data.append({"context": context, "question": question, "answer": answer})

    write_simplified_file(output_file, simplified_data)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert SQuAD-format JSON file to simplified JSON file with context, questions, and answers.")
